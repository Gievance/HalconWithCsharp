...
public partial class HDevelopExport
{
        ...
        try
        {
            ...
            try
            {
                ...
                if ((int)(new HTuple(ExpGetGlobalVar_gUsesOpenGL().TupleEqual("true"))) != 0)
                {
                    ...
                    if ((int)(new HTuple(hv_OpenGLInfo.TupleRegexpTest("^No OpenGL support"))) != 0)
                    {
                        ExpTmpLocalVar_gUsesOpenGL = "false";
                        ExpSetGlobalVar_gUsesOpenGL(ExpTmpLocalVar_gUsesOpenGL);
                    }
    ...
    public void test_normal_direction(HTuple hv_ObjectModel3D, out HTuple hv_InvertNormal)
    {
        ...
        try
        {
            ...
            if ((int)(new HTuple(hv_Test1.TupleLess(hv_Test2))) != 0)
            {
                hv_InvertNormal.Dispose();
    ...
    private void action()
    {
        ...
        HObject ho_Image = null, ho_ImageGray = null;

        // Local control variables 

        HTuple hv_WindowHandle = new HTuple(), hv_CameraParam = new HTuple();
        HTuple hv_Pose = new HTuple(), hv_genParam = new HTuple();
        HTuple hv_genParamVal = new HTuple(), hv_HomMat3DIdentity = new HTuple();
        HTuple hv_HomMat3DComp = new HTuple(), hv_ObjectModel3D = new HTuple();
        HTuple hv_Status = new HTuple(), hv_baseLine3D = new HTuple();
        HTuple hv_RegistryModel3d = new HTuple(), hv_poseHom = new HTuple();
        HTuple hv_numImage = new HTuple(), hv_idx = new HTuple();
        HTuple hv_Status1 = new HTuple(), hv_GenParamValue = new HTuple();
        HTuple hv_Pose1 = new HTuple(), hv_Score = new HTuple();
        HTuple hv_HomMat3D = new HTuple(), hv_ObjectModel3DAffineTrans = new HTuple();
        HTuple hv_PoseOut = new HTuple(), hv_HomMats3DOut = new HTuple();
        HTuple hv_Scores = new HTuple(), hv_ObjectModel3DAffineTrans1 = new HTuple();
        HTuple hv_UnionObjectModel3D = new HTuple(), hv_SampledObjectModel3D = new HTuple();
        HTuple hv_Box = new HTuple(), hv_Center = new HTuple();
        HTuple hv_HomMat3DTranslate = new HTuple(), hv_ObjectModel3DTrans = new HTuple();
        HTuple hv_HomMat3DInvert = new HTuple(), hv_SmoothObjectModel3D = new HTuple();
        HTuple hv_TriangulatedObjectModel3D = new HTuple(), hv_Information = new HTuple();
        HTuple hv_ObjectModel3DConnected = new HTuple(), hv_ObjectModel3DSelected = new HTuple();
        HTuple hv_InvertNormal = new HTuple(), hv_SurfaceModelID = new HTuple();
        HTuple hv_ImageFiles = new HTuple(), hv_CheckImageNums = new HTuple();
        HTuple hv_select_num = new HTuple(), hv__ = new HTuple();
        HTuple hv_rows = new HTuple(), hv_cols = new HTuple();
        HTuple hv_Grayval = new HTuple(), hv_Pose2 = new HTuple();
        HTuple hv_Score1 = new HTuple(), hv_SurfaceMatchingResultID = new HTuple();
        HTuple hv_HomMat3D1 = new HTuple(), hv_ObjectModel3DAffineTrans2 = new HTuple();
        HTuple hv_GenParamValue1 = new HTuple(), hv_ObjectModel3DTraget = new HTuple();
        HTuple hv_ObjectModel3DBG = new HTuple();
        // Initialize local and output iconic variables 
        HOperatorSet.GenEmptyObj(out ho_Image);
        ...
        try
        {
            ...
            HOperatorSet.OpenWindow(0, 0, 760, 400, 0, "visible", "", out hv_WindowHandle);
            HDevWindowStack.Push(hv_WindowHandle);
            hv_CameraParam.Dispose();
            gen_cam_par_area_scan_division(0.06, 0, 8.5e-6, 8.5e-6, 380.0, 150.0, 760,
                300, out hv_CameraParam);
            hv_Pose.Dispose();
            HOperatorSet.CreatePose(70, -20, 1800, 128, 345, 185, "Rp+T", "gba", "point",
                out hv_Pose);

            hv_genParam.Dispose();
            hv_genParam = "disp_pose";
            hv_genParamVal.Dispose();
            hv_genParamVal = 1;
            hv_HomMat3DIdentity.Dispose();
            HOperatorSet.HomMat3dIdentity(out hv_HomMat3DIdentity);
            hv_HomMat3DComp.Dispose();
            hv_HomMat3DComp = new HTuple(hv_HomMat3DIdentity);


            //构建3D对象模型，成对配准=相邻帧配准方式
            hv_ObjectModel3D.Dispose(); hv_Status.Dispose();
            HOperatorSet.ReadObjectModel3d("E:/MVTec_Coding/素材/om3/universal_joint_part_xyz_00.om3",
                "m", new HTuple(), new HTuple(), out hv_ObjectModel3D, out hv_Status);
            hv_baseLine3D.Dispose();
            hv_baseLine3D = new HTuple(hv_ObjectModel3D);

            hv_RegistryModel3d.Dispose();
            hv_RegistryModel3d = new HTuple(hv_ObjectModel3D);
            hv_poseHom.Dispose();
            hv_poseHom = new HTuple();

            hv_numImage.Dispose();
            hv_numImage = 15;
            HTuple end_val20 = hv_numImage - 1;
            HTuple step_val20 = 1;
            for (hv_idx = 1; hv_idx.Continue(end_val20, step_val20); hv_idx = hv_idx.TupleAdd(step_val20))
            {
                using (HDevDisposeHelper dh = new HDevDisposeHelper())
                {
                    hv_ObjectModel3D.Dispose(); hv_Status1.Dispose();
                    HOperatorSet.ReadObjectModel3d("E:/MVTec_Coding/素材/om3/universal_joint_part_xyz_" + (hv_idx.TupleString(
                        "02")), "m", new HTuple(), new HTuple(), out hv_ObjectModel3D, out hv_Status1);
                }

                hv_GenParamValue.Dispose();
                HOperatorSet.GetObjectModel3dParams(hv_ObjectModel3D, "num_points", out hv_GenParamValue);
                if ((int)(new HTuple(hv_GenParamValue.TupleLess(20000))) != 0)
                {
                    continue;
                }
                hv_Pose1.Dispose(); hv_Score.Dispose();
                HOperatorSet.RegisterObjectModel3dPair(hv_ObjectModel3D, hv_baseLine3D, "matching",
                    "default_parameters", "accurate", out hv_Pose1, out hv_Score);
                if ((int)((new HTuple((new HTuple(hv_Pose1.TupleLength())).TupleEqual(0))).TupleOr(
                    new HTuple(hv_Score.TupleLess(0.8)))) != 0)
                {
                    continue;
                }

                hv_HomMat3D.Dispose();
                HOperatorSet.PoseToHomMat3d(hv_Pose1, out hv_HomMat3D);
                {
                    HTuple ExpTmpOutVar_0;
                    HOperatorSet.HomMat3dCompose(hv_HomMat3DComp, hv_HomMat3D, out ExpTmpOutVar_0);
                    hv_HomMat3DComp.Dispose();
                    hv_HomMat3DComp = ExpTmpOutVar_0;
                }
                hv_ObjectModel3DAffineTrans.Dispose();
                HOperatorSet.AffineTransObjectModel3d(hv_ObjectModel3D, hv_HomMat3DComp,
                    out hv_ObjectModel3DAffineTrans);

                //CollectModel3D := [baseLine3D,ObjectModel3DAffineTrans]
                //visualize_object_model_3d (WindowHandle, CollectModel3D, CameraParam, Pose, 'disp_pose', 'true', [], [], [], PoseOut)
                hv_baseLine3D.Dispose();
                hv_baseLine3D = new HTuple(hv_ObjectModel3D);
                using (HDevDisposeHelper dh = new HDevDisposeHelper())
                {
                    {
                        HTuple
                          ExpTmpLocalVar_RegistryModel3d = hv_RegistryModel3d.TupleConcat(
                            hv_ObjectModel3D);
                        hv_RegistryModel3d.Dispose();
                        hv_RegistryModel3d = ExpTmpLocalVar_RegistryModel3d;
                    }
                }
                using (HDevDisposeHelper dh = new HDevDisposeHelper())
                {
                    {
                        HTuple
                          ExpTmpLocalVar_poseHom = hv_poseHom.TupleConcat(
                            hv_HomMat3D);
                        hv_poseHom.Dispose();
                        hv_poseHom = ExpTmpLocalVar_poseHom;
                    }
                }

                using (HDevDisposeHelper dh = new HDevDisposeHelper())
                {
                    disp_message(hv_WindowHandle, new HTuple("当前点云数组长度：") + (new HTuple(hv_RegistryModel3d.TupleLength()
                        )), "window", 0, 0, "black", "true");
                }
                using (HDevDisposeHelper dh = new HDevDisposeHelper())
                {
                    disp_message(hv_WindowHandle, new HTuple("当前Offsets矩阵数量：") + (new HTuple(hv_poseHom.TupleLength()
                        )), "window", 40, 0, "black", "true");
                }
            }

            //全局配准
            hv_HomMats3DOut.Dispose(); hv_Scores.Dispose();
            HOperatorSet.RegisterObjectModel3dGlobal(hv_RegistryModel3d, hv_poseHom, "previous",
                new HTuple(), "max_num_iterations", 1, out hv_HomMats3DOut, out hv_Scores);
            hv_ObjectModel3DAffineTrans1.Dispose();
            HOperatorSet.AffineTransObjectModel3d(hv_RegistryModel3d, hv_HomMats3DOut,
                out hv_ObjectModel3DAffineTrans1);
            if (HDevWindowStack.IsOpen())
            {
            ...
            HOperatorSet.UnionObjectModel3d(hv_ObjectModel3DAffineTrans1, "points_surface",
                out hv_UnionObjectModel3D);
            //visualize_object_model_3d (WindowHandle, ObjectModel3DAffineTrans1, CameraParam, Pose, ['color','disp_background','point_size'], ['gray','true',1], [], [], [], PoseOut)

            //********** 3D点云数据处理  ******************
            //子采样，降低重叠区域的点数
            hv_SampledObjectModel3D.Dispose();
            HOperatorSet.SampleObjectModel3d(hv_UnionObjectModel3D, "accurate", 0.5, "min_num_points",
                5, out hv_SampledObjectModel3D);
            if (HDevWindowStack.IsOpen())
            {
                HOperatorSet.ClearWindow(HDevWindowStack.GetActive());
            }
            hv_PoseOut.Dispose();
            visualize_object_model_3d(hv_WindowHandle, hv_SampledObjectModel3D, hv_CameraParam,
                hv_Pose, ((new HTuple("color")).TupleConcat("disp_background")).TupleConcat(
                "point_size"), ((new HTuple("gray")).TupleConcat("true")).TupleConcat(1),
                new HTuple(), new HTuple(), new HTuple(), out hv_PoseOut);

            //点云平滑处理
            hv_Box.Dispose();
            HOperatorSet.GetObjectModel3dParams(hv_SampledObjectModel3D, "bounding_box1",
                out hv_Box);
            hv_Center.Dispose();
            HOperatorSet.GetObjectModel3dParams(hv_SampledObjectModel3D, "center", out hv_Center);
            ...
            using (HDevDisposeHelper dh = new HDevDisposeHelper())
            {
                ...
                HOperatorSet.HomMat3dTranslate(hv_HomMat3DIdentity, -(hv_Center.TupleSelect(
                    0)), -(hv_Center.TupleSelect(1)), -(hv_Box.TupleSelect(2)), out hv_HomMat3DTranslate);
            }

            hv_ObjectModel3DTrans.Dispose();
            HOperatorSet.AffineTransObjectModel3d(hv_SampledObjectModel3D, hv_HomMat3DTranslate,
                out hv_ObjectModel3DTrans);
            hv_HomMat3DInvert.Dispose();
            HOperatorSet.HomMat3dInvert(hv_HomMat3DTranslate, out hv_HomMat3DInvert);
            {
                HTuple ExpTmpOutVar_0;
                HOperatorSet.AffineTransObjectModel3d(hv_ObjectModel3DTrans, hv_HomMat3DInvert,
                    out ExpTmpOutVar_0);
                hv_ObjectModel3DTrans.Dispose();
                hv_ObjectModel3DTrans = ExpTmpOutVar_0;
            }
            hv_SmoothObjectModel3D.Dispose();
            HOperatorSet.SmoothObjectModel3d(hv_ObjectModel3DTrans, "mls", "mls_force_inwards",
                "true", out hv_SmoothObjectModel3D);
            if (HDevWindowStack.IsOpen())
            {
                HOperatorSet.ClearWindow(HDevWindowStack.GetActive());
            }
            hv_PoseOut.Dispose();
            visualize_object_model_3d(hv_WindowHandle, hv_SmoothObjectModel3D, hv_CameraParam,
                hv_Pose, ((new HTuple("color")).TupleConcat("disp_background")).TupleConcat(
                "point_size"), ((new HTuple("gray")).TupleConcat("true")).TupleConcat(1),
                new HTuple(), new HTuple(), new HTuple(), out hv_PoseOut);
            ...
            HOperatorSet.TriangulateObjectModel3d(hv_SmoothObjectModel3D, "greedy", new HTuple(),
            ...
            hv_PoseOut.Dispose();
            visualize_object_model_3d(hv_WindowHandle, hv_TriangulatedObjectModel3D, hv_CameraParam,
                hv_Pose, ((new HTuple("color")).TupleConcat("disp_background")).TupleConcat(
                "point_size"), ((new HTuple("gray")).TupleConcat("true")).TupleConcat(1),
                new HTuple(), new HTuple(), new HTuple(), out hv_PoseOut);
            ...
            HOperatorSet.ConnectionObjectModel3d(hv_TriangulatedObjectModel3D, "mesh",
                1, out hv_ObjectModel3DConnected);
            hv_ObjectModel3DSelected.Dispose();
            HOperatorSet.SelectObjectModel3d(hv_ObjectModel3DConnected, (new HTuple("has_triangles")).TupleConcat(
                "num_triangles"), "and", (new HTuple(1)).TupleConcat(20000), (new HTuple(1)).TupleConcat(
                30000), out hv_ObjectModel3DSelected);
            if (HDevWindowStack.IsOpen())
            {
                HOperatorSet.ClearWindow(HDevWindowStack.GetActive());
            }
            hv_PoseOut.Dispose();
            visualize_object_model_3d(hv_WindowHandle, hv_ObjectModel3DSelected, hv_CameraParam,
                hv_Pose, ((new HTuple("color")).TupleConcat("disp_background")).TupleConcat(
                "point_size"), ((new HTuple("gray")).TupleConcat("true")).TupleConcat(1),
                new HTuple(), new HTuple(), new HTuple(), out hv_PoseOut);
            ...
            //确定法线方向
            hv_InvertNormal.Dispose();
            test_normal_direction(hv_ObjectModel3DSelected, out hv_InvertNormal);
            //********* 3D表面匹配与验证************
            //创建3D表面匹配模版
            hv_SurfaceModelID.Dispose();
            HOperatorSet.CreateSurfaceModel(hv_ObjectModel3DSelected, 0.03, "model_invert_normals",
                hv_InvertNormal, out hv_SurfaceModelID);
            //读取图像视图
            hv_ImageFiles.Dispose();
            list_image_files("E:/MVTec_Coding/素材/素材", "png", new HTuple(), out hv_ImageFiles);
            hv_CheckImageNums.Dispose();
            using (HDevDisposeHelper dh = new HDevDisposeHelper())
            {
                hv_CheckImageNums = (new HTuple(hv_ImageFiles.TupleLength()
                    )) - hv_numImage;
            }
            HTuple end_val93 = hv_CheckImageNums;
            HTuple step_val93 = 1;
            for (hv_idx = 1; hv_idx.Continue(end_val93, step_val93); hv_idx = hv_idx.TupleAdd(step_val93))
            {
                hv_select_num.Dispose();
                using (HDevDisposeHelper dh = new HDevDisposeHelper())
                {
                    hv_select_num = (hv_numImage + hv_idx) - 1;
                }
                using (HDevDisposeHelper dh = new HDevDisposeHelper())
                {
                    ho_Image.Dispose();
                    HOperatorSet.ReadImage(out ho_Image, hv_ImageFiles.TupleSelect(hv_select_num));
                }
                using (HDevDisposeHelper dh = new HDevDisposeHelper())
                {
                    disp_message(hv_WindowHandle, hv_ImageFiles.TupleSelect(hv_select_num), "window",
                        12, 12, "red", "false");
                }

                using (HDevDisposeHelper dh = new HDevDisposeHelper())
                {
                    hv_ObjectModel3D.Dispose(); hv__.Dispose();
                    HOperatorSet.ReadObjectModel3d("E:/MVTec_Coding/素材/om3/universal_joint_part_xyz_" + (hv_select_num.TupleString(
                        "02")), "m", new HTuple(), new HTuple(), out hv_ObjectModel3D, out hv__);
                }

                hv_rows.Dispose();
                HOperatorSet.GetObjectModel3dParams(hv_ObjectModel3D, "mapping_row", out hv_rows);
                hv_cols.Dispose();
                HOperatorSet.GetObjectModel3dParams(hv_ObjectModel3D, "mapping_col", out hv_cols);

                ho_ImageGray.Dispose();
                HOperatorSet.AccessChannel(ho_Image, out ho_ImageGray, 1);
                hv_Grayval.Dispose();
                HOperatorSet.GetGrayval(ho_ImageGray, hv_rows, hv_cols, out hv_Grayval);
                HOperatorSet.SetObjectModel3dAttribMod(hv_ObjectModel3D, "&gray", "points",
                    hv_Grayval);

                hv_Pose2.Dispose(); hv_Score1.Dispose(); hv_SurfaceMatchingResultID.Dispose();
                HOperatorSet.FindSurfaceModel(hv_SurfaceModelID, hv_ObjectModel3D, 0.05,
                    0.2, 0, "false", new HTuple(), new HTuple(), out hv_Pose2, out hv_Score1,
                    out hv_SurfaceMatchingResultID);

                hv_HomMat3D1.Dispose();
                HOperatorSet.PoseToHomMat3d(hv_Pose2, out hv_HomMat3D1);
                hv_ObjectModel3DAffineTrans2.Dispose();
                HOperatorSet.AffineTransObjectModel3d(hv_ObjectModel3DSelected, hv_HomMat3D1,
                    out hv_ObjectModel3DAffineTrans2);
                ...
                {
                    hv_PoseOut.Dispose();
                    visualize_object_model_3d(hv_WindowHandle, hv_ObjectModel3D.TupleConcat(hv_ObjectModel3DAffineTrans2),
                        hv_CameraParam, hv_Pose, (((new HTuple("alpha_1")).TupleConcat("color_0")).TupleConcat(
                        "color_attrib_start")).TupleConcat("color_attrib_end"), (((new HTuple(0.8)).TupleConcat(
                        "green")).TupleConcat(0)).TupleConcat(255), new HTuple(), new HTuple(),
                        new HTuple(), out hv_PoseOut);
                }

                //* 计算读取3D场景模型与模型的距离
                HOperatorSet.DistanceObjectModel3d(hv_ObjectModel3D, hv_ObjectModel3DAffineTrans2,
                    new HTuple(), 0, "distance_to", "points");
                //* 获取距离值
                hv_GenParamValue1.Dispose();
                HOperatorSet.GetObjectModel3dParams(hv_ObjectModel3D, "&distance", out hv_GenParamValue1);
                //* 根据距离分割背景和目标点云
                hv_ObjectModel3DTraget.Dispose();
                HOperatorSet.SelectPointsObjectModel3d(hv_ObjectModel3D, "&distance", 0,
                    2, out hv_ObjectModel3DTraget);
                hv_ObjectModel3DBG.Dispose();
                HOperatorSet.SelectPointsObjectModel3d(hv_ObjectModel3D, "&distance", 2,
                    100, out hv_ObjectModel3DBG);
                if (HDevWindowStack.IsOpen())
                {
                    HOperatorSet.ClearWindow(HDevWindowStack.GetActive());
                }
                ...
                {
                    HTuple ExpTmpOutVar_0;
                    visualize_object_model_3d(hv_WindowHandle, hv_ObjectModel3DTraget.TupleConcat(
                        hv_ObjectModel3DBG), hv_CameraParam, hv_Pose, ((((((new HTuple("color_1")).TupleConcat(
                        "color_attrib_1")).TupleConcat("color_attrib_0")).TupleConcat("color_attrib_start_0")).TupleConcat(
                        "color_attrib_end_0")).TupleConcat("lut_0")).TupleConcat("disp_background"),
                        ((((((new HTuple("blue")).TupleConcat("&distance")).TupleConcat("&distance")).TupleConcat(
                        2)).TupleConcat(-2)).TupleConcat("color1")).TupleConcat("true"), new HTuple(),
                        new HTuple(), new HTuple(), out ExpTmpOutVar_0);
                    hv_Pose.Dispose();
